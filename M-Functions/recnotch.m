...
% the last row. W must be an odd number to preserve the symmet ry 
...
elseif strcmp (mode, 'vertical') 
    AV = 0; 
    AH = 1; 
    % No reject filtering along horizontal axis. 
end
if mod(W,2)==0 
...
% Uncenter the filter to make it compatible with other f ilters i n 
% the OIPUM toolbox. 
H = ifftshift(H); 
