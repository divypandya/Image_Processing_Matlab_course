...
% 'gaussian '     Gaussian random numbers with mean A and standard deviation B. 
%                 The default values are A = 0, B = 1. 
...
%                 The noise matrix R is assigned three values.
%                 If R( x, y) = 0, the noise at (x, y) is pepper (black).
%                 If R(x, y) = 1, the noise at (x, y) is salt (white).
%                 If R(x, y) = 0.5, there is no noise assigned to 
%                 coordinates (x, y).
% 
