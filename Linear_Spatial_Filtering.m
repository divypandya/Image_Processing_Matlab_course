...
%%**Linear Spatial Filtering :- Correlation and Convolution**%%
%imfilter to find convolution and correlation of f and w
gconv=imfilter(f,w,'conv','replicate'); %calculates convolution of f and w
figure, imshow(gconv);
gcorr=imfilter(f,w,'corr','replicate');
figure, imshow(gcorr);
...
figure, imshow(g1,[]); %plotting floating point filtered image
